        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at CaseCobra believe that a phone case doesn&rsquo;t only need
              to look good, but also last you for the years to come. We offer a
              5-year print guarantee: If you case isn&rsquo;t of the highest
              quality, we&rsquo;ll replace it for free.
            </p>
          </div>
        </div>
